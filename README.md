...
|`pause` (optional)|The default behavior is to not allow pausing a timed EGRA test. You can omit the pause parameter if the default behavior is undesirable. However, if you would like the user to be allowed to pause the test, specify `pause = 1`.|
